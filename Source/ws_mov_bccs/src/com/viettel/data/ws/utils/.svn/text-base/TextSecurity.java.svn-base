...
public class TextSecurity {
    ...
    public byte[] encryptPass2(String pass) throws InvalidKeyException, NoSuchAlgorithmException, InvalidKeySpecException, NoSuchPaddingException {
        computeDigest("SecretWord", TextSecurity.MessageDigestAlgorithm.MD5);
        computeDigest("SecretWord", TextSecurity.MessageDigestAlgorithm.SHA);
    ...
    public static TextSecurity getInstance() {
        if (mMe == null) {
            ...
            mMe.share_key = "BBF18733B94867F641EACBBE96B16ABA6AC70F5BE401A873A30A8A967BE0823F";
        }
    ...
    public void setDefaultKey() {
        this.share_key = "BBF18733B94867F641EACBBE96B16ABA6AC70F5BE401A873A30A8A967BE0823F";
    }
}
